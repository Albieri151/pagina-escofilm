...
const EscofilmLogo = ({ className = "h-8" }) => (
  <svg viewBox="0 0 240 60" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Línea decorativa técnica que evoca el "frame" de una cámara */}
    <path d="M 145 15 L 210 15" stroke="currentColor" strokeWidth="2" />
    <path d="M 145 15 L 145 25" stroke="currentColor" strokeWidth="2" />
    <circle cx="215" cy="15" r="2" fill="#fbbf24" /> {/* Punto dorado de grabación */}
  </svg>
);
...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-500 ${
      isScrolled || isMobileMenuOpen ? 'bg-black/95 backdrop-blur-lg border-b border-zinc-800 py-4' : 'bg-transparent py-6'
    }`}>
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
         <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center opacity-30 mix-blend-luminosity"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto mt-10">
        <div className="flex justify-center mb-8">
            <div className="px-4 py-2 border border-amber-400/30 bg-amber-400/5 rounded-full backdrop-blur-md flex items-center gap-2">
        ...
        <h1 className="text-5xl md:text-8xl lg:text-9xl font-black text-white mb-8 tracking-tighter leading-[0.9]">
          CREAMOS<br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 via-zinc-500 to-zinc-700">LEGADO VISUAL</span>
        </h1>
        
        <p className="mt-6 max-w-2xl mx-auto text-lg text-zinc-400 font-light leading-relaxed">
          Especialistas en traducir la identidad corporativa en contenido digital de alto impacto. 
          Video, Fotografía y Estrategia para marcas líderes.
        </p>

        <div className="mt-12 flex flex-col sm:flex-row justify-center gap-6">
          <a href="#portafolio" className="group relative px-8 py-4 bg-white text-black font-bold text-sm tracking-widest uppercase flex items-center justify-center gap-3 transition-all hover:bg-amber-400">
            Ver Showreel
            <Play size={14} className="fill-current" />
          </a>
          <a href="#contacto" className="px-8 py-4 border border-zinc-700 text-white font-bold text-sm tracking-widest uppercase hover:bg-zinc-900 hover:border-white transition-all">
...
// --- ABOUT SECTION (Refined for "Who are you?" brief question) ---
const About = () => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative aspect-[3/4] overflow-hidden bg-zinc-900 rounded-sm grayscale hover:grayscale-0 transition-all duration-700">
              <img 
                src="https://images.unsplash.com/photo-1533174072545-e8d4aa97edf9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" 
  ...
  const services = [
    {
      ...
      desc: "Video corporativo, comerciales y cobertura de eventos con equipos de cine digital (4K/6K).",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto md:h-[600px]">
            ...
            <div className="relative group overflow-hidden bg-zinc-900">
                <img src="https://images.unsplash.com/photo-1542206391-7f30f79b83b6?w=800&q=80" alt="Corporate" className="w-full h-full object-cover opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700"/>
                 <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center">
                    <div className="text-white font-bold text-sm">Tech Launch</div>
                 </div>
            </div>
            {/* Project 3 */}
            <div className="relative group overflow-hidden bg-zinc-900">
    ...
    <section id="contacto" className="py-32 bg-zinc-950 relative border-t border-zinc-900">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mt-16 flex items-center justify-center gap-2 text-zinc-600 text-xs uppercase tracking-widest">
            <ShieldCheck size={14} />
            <span>Datos Protegidos bajo NDA</span>
        </div>
      </div>
    </section>
  );
